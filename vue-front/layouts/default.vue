  ...
  <div class="in-wrap">
    ...
    <header id="header">
      <section class="container">
        <h1 id="logo">
          <a href="#" title="k12在线学院">
            <img src="../assets/img/logo.png" width="100%" alt="k12在线学院">
          </a>
        </h1>
        <div class="h-r-nsl">
          <ul class="nav">
          ...
          <section class="fl col-7">
            <section class="mr20">
              <section class="b-f-link">
                ...
                <a href="#" title="我们" target="_blank">飞☼德♂超※宇◐</a>|
                <a href="#" title="联系我们" target="_blank">联系我们</a>|
                <a href="#" title="帮助中心" target="_blank">帮助中心</a>|
                <a href="#" title="资源下载" target="_blank">资源下载</a>|
                <span>服务热线：123456(北京) 7890121(深圳)</span>
                <span>Email：1903203411@qq.com</span>
              </section>
              <section class="b-f-link mt10">
                <span>©2020版权均作者归所有 京ICP备xxxxxxxx号</span>
              </section>
            </section>
          </section>
